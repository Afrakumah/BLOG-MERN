    ...
    <div className="min-h-screen mt-20">
      <div className="flex p-3 gap-1 max-w-3xl mx-auto flex-col md:flex-row md:items-center">
        <div className="flex-1">
          ...
          >
            <span className="px-2 py1 bg-gradient-to-r from-purple-400
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-4"onSubmit={handleSubmit}>
            <div>
              ...
              <TextInput onChange={handleChange}  type="text" placeholder="Enter Username" id="username" />
            </div>
            <div>
              <Label value="Your Email" />
              <TextInput onChange={handleChange} type="email" placeholder="Enter Email" id="email" />
            </div>
            <div>
              <Label value="Your Password" />
              <TextInput onChange={handleChange} type="password" placeholder="Enter Password" id="password" />
            </div>
